...
if(isset($_POST['nom_oeuvre']) AND isset($_POST['type_oeuvre']) AND isset($_POST['categorie_oeuvre']) AND isset($_POST['auteur_oeuvre']) AND isset($_POST['stock_exemplaire']) AND isset($_POST['description_oeuvre'])){
    ...
    <body>
        ...
        <div class="container">
            ...
            <section id="exemplaire_liste">
                    ...
                    <h2>Message de confirmation de d'ajout d'exemplaire</h2>
    
                    <p class='p_end'>
                        L'exemplaire a bien été ajouté.
                    </p>
    
                    <a href="add_book.php">Retour a la page d'ajout de livre</a>
    ...
    <?php  
}else if( (isset($_POST['nom_auteur']) AND !empty($_POST['nom_auteur'])) OR (isset($_POST['nom_categorie']) AND !empty($_POST['nom_categorie'])) OR (isset($_POST['nom_type']) AND !empty($_POST['nom_type'])) ){
    if(isset($_POST['nom_auteur']) AND!empty($_POST['nom_auteur'])){
        $add_auteur = $bdd -> prepare('INSERT INTO autheur_livre (nom) VALUES(:nom)');
        $add_auteur -> execute(array(
    ...
    if(isset($_POST['nom_categorie']) AND !empty($_POST['nom_categorie'])){
        $add_categorie = $bdd -> prepare('INSERT INTO categorie_livre (nom) VALUES(:nom)');
        $add_categorie -> execute(array(
    ...
    if(isset($_POST['nom_type']) AND !empty($_POST['nom_type'])){
        $add_type_oeuvre = $bdd -> prepare('INSERT INTO type_oeuvre (nom) VALUES(:nom)');
        $add_type_oeuvre -> execute(array(
        ...
        <div class="container">
            ...
            <div class="center">
                <section id="exemplaire_liste">
                    ...
                    <p class='p_end'>
                    <?php if(isset($_POST['nom_auteur']) AND !empty($_POST['nom_auteur'])){echo 'l\'auteur, ';} ?>
                    <?php if(isset($_POST['nom_categorie']) AND !empty($_POST['nom_categorie'])){echo 'la categorie, ';} ?>
                    <?php if(isset($_POST['nom_type']) AND !empty($_POST['nom_type'])){echo 'La type d\'oeuvre ';} ?>
                    a bien été ajouté.
                    </p>
            ...
            <div class='center'>
                    ...
                    <p>
                        ...
                        <div class='radio-style'>
                            <label for="check_oeuvre">
                                <input type="radio" name="check_formulaire" id="check_oeuvre" onClick="change ('formulaire_ajout_oeuvre','formulaire_ajout_exemplaire','formulaire_ajout_information_oeuvre');" />
                                Ajouter une oeuvre
                            </label>
                            <label for="check_exemplaire">
                                <input type="radio" name="check_formulaire" id="check_exemplaire" onClick="change ('formulaire_ajout_exemplaire','formulaire_ajout_oeuvre','formulaire_ajout_information_oeuvre');" />
                                Ajouter une exemplaire
                            </label>
                            <label for="check_information">
                                <input type="radio" name="check_formulaire" id="check_information" onClick="change ('formulaire_ajout_information_oeuvre','formulaire_ajout_exemplaire','formulaire_ajout_oeuvre');" />
                                Ajouter une information d'oeuvre
                            </label>
                        </div>
                    </p>
                </section>
                ...
                <section id="formulaire_ajout_information_oeuvre">
                    ...
                    <form method="POST"action="#">
                        ...
                        <p>
                            <label for="nom_auteur">Entrer le nom du nouvelle auteur:</label>
                            <input type="text" name="nom_auteur" id="nom_auteur" placeholder="nom de l'auteur" />
                        </p>
                        <p>
                            <label for="nom_categorie">Entrer le nom de la nouvelle categorie d'oeuvre:</label>
                            <input type="text" name="nom_categorie" id="nom_categorie" placeholder="nom de la categorie d'oeuvre" />
                        </p>
                        <p>
                            <label for="nom_type">Entrer le nom du nouveau type d'oeuvre:</label>
                            <input type="text" name="nom_type" id="nom_type" placeholder="nom du type d'oeuvre" />
                        </p>
                        <input type="submit" name="valider" value="valider" />
                    </form>
                </section>
